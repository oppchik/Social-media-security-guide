...
<div class="wa-info-block">
  ...
  <div class="wa-info-text">
    <strong>Ваша конфиденциальность — наш приоритет.</strong> В отличие от других мессенджеров, WhatsApp* по умолчанию использует сквозное шифрование. Это значит, что ваши сообщения и звонки защищены так, что даже сам WhatsApp* не может их прочитать или прослушать.
  </div>
</div>
