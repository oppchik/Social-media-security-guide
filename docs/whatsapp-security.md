...
<div class="wa-security-list">
  ...
  <div class="wa-security-item">
    ...
    <span>Проверяйте, кто добавляет вас в группы, и не открывайте файлы от незнакомых участников.</span>
  </div>
  <div class="wa-security-item">
    <strong>Проектные договоренности</strong>
    <span>Важные дедлайны, ссылки и материалы лучше дублировать вне одного мессенджера.</span>
  </div>
</div>
