...
<div class="dc-notifications-grid">
  ...
  <div class="dc-notify-card">
    <div class="dc-notify-icon">✉️</div>
    <div class="dc-notify-content">
      <h3>Почта для восстановления</h3>
      <p>Проверьте, что привязанная почта актуальна и на неё тоже включена защита входа.</p>
    </div>
  </div>
</div>

## Ключевые настройки (со скриншотами)
...
<div class="dc-platform-grid platform-grid">
  ...
  <label class="interactive-flip-card">
    ...
    <div class="flip-inner">
      <div class="flip-front platform-card">
        <h3>Двухфакторная аутентификация</h3>
        <p>Дополнительный фактор резко снижает шанс захвата аккаунта даже при украденном пароле.</p>
        <div class="click-hint">👆 Нажмите, чтобы посмотреть скриншот</div>
      </div>
      <div class="flip-back platform-card">
