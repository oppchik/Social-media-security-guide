...
<div class="url-anatomy animate-trigger">
  ...
  <div class="url-tooltip-area">
    <div class="url-rule-box">
      <strong>Правило:</strong> Нажмите на любую часть ссылки выше, чтобы узнать детали.
    </div>
  </div>
</div>
  ...
  <div class="scenario-tabs">
    ...
    <div class="scenario-panels">
      ...
      <div class="scenario-panel" id="panel6">
        <div class="scenario-message">
          <div class="scenario-msg-bubble"><strong>Игровая платформа Steam:</strong> Привет! Добавь меня в друзья, нашёл кое-что интересное для тебя: stearncommunity.com</div>
        </div>
        <div class="scenario-analysis">
          <span class="sc-red">Что не так</span>
          <p>Поддельный сайт, буквы отличаются. После перехода ваши данные украдут и восстановить их будет очень трудно.</p>
          <span class="sc-green">Как реагировать</span>
          <p>Внимательно смотрите ссылку, на которую вам предлагают перейти, если что-то заметили, переспросите собеседника.</p>
        </div>
      </div>
    </div>
  </div>
