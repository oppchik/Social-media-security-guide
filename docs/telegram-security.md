...
<div class="tg-info-block">
  ...
  <div class="tg-info-text">
    <strong>Мессенджер и облако в одном приложении.</strong> Telegram хранит переписку, медиа, контакты и привязку к номеру телефона. Потеря аккаунта даёт доступ ко всему этому сразу, поэтому защита входа и сеансов здесь особенно важна.
  </div>
</div>

> Измените настройки, если не хотите стать админом воздуханского крипто-канала без вашего согласия...
<br>
...
<div class="tg-notifications-grid">
  <div class="tg-notify-card">
    ...
    <div class="tg-notify-content">
      ...
      <p>Включите двухэтапную проверку и задайте надёжный облачный пароль, потому что без него войти с нового устройства будет значительно сложнее.</p>
    </div>
  </div>
  ...
  <div class="tg-notify-card">
    ...
    <div class="tg-notify-content">
      ...
      <p>Включите код-пароль или биометрию в настройках, чтобы при потере телефона переписку нельзя было просто открыть.</p>
    </div>
  </div>
  ...
  <div class="tg-notify-card">
    ...
    <div class="tg-notify-content">
      ...
      <p>Ограничьте, кто видит ваш телефон, фото и время «был в сети» — это снижает риск спама.</p>
    </div>
  </div>
</div>
...
<div class="tg-recovery-steps">
  <div class="tg-step">
    ...
    <div class="tg-step-text">
      ...
      <p>Убедитесь, что SIM-карта и доступ к номеру только у вас — без этого восстановление через Telegram будет тяжким.</p>
    </div>
  </div>
  <div class="tg-step">
    <div class="tg-step-point"></div>
