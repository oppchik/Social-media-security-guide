...
<div class="info-block-purple">
  Instagram сочетает мессенджер, облачное хранение переписки, каналы и группы. Потеря контроля над данными может повлечь серьёзные последствия.
</div>

## Что нужно сделать в первую очередь

<div class="emergency-container">
  <div class="emergency-card purple-step">
...
<div class="audience-list">
  <div class="audience-item purple-theme">
...
<div class="learning-path purple-theme">
  <div class="path-step">
