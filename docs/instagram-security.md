...
<div class="info-block-ig">
  ...
  <div class="ig-info-text">
    <strong>Ваш цифровой архив:</strong> Instagram — это не просто картинки, это ваши воспоминания, личный бренд и переписки в Direct. Потеря контроля над аккаунтом грозит утечкой личной информации и обманом ваших подписчиков.
  </div>
</div>
