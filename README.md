...
Проект представляет собой готовый демонстрационный информационно-образовательный сайт на `VitePress`, разработанный в рамках Проектного практикума в УрФУ (2 семестр). Материалы ориентированы на **студентов гуманитарных специальностей** и обычных пользователей и посвящены практической защите аккаунтов в социальных сетях и персональных данных.

> 💡 **Быстрый старт:** Сайт можно просмотреть онлайн по ссылке, указанной в описании проекта на GitHub (раздел "About").
