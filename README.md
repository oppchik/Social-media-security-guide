...
Проект представляет собой готовый демонстрационный информационно-образовательный сайт на `VitePress`, разработанный в рамках Проектного практикума в УрФУ (2 семестр). <br>
